...
#ax_515.plot([1.95, 1.95], [10, 1000000], color="black", linestyle="dotted", linewidth=1.5)

ax_443.plot(depths, [d**2*ion_rate[1] for d in depths])
ax_443.plot(depths, [d*inelastic_rates[1] for d in depths], linestyle="dashed")
#ax_443.plot([2.41, 2.41], [10, 1000000], color="black", linestyle="dotted", linewidth=1.5)

ax_414.plot(depths, [d**2*ion_rate[2] for d in depths])
ax_414.plot(depths, [d*inelastic_rates[2] for d in depths], linestyle="dashed")
#ax_414.plot([2.82, 2.82], [10, 1000000], color="black", linestyle="dotted", linewidth=1.5)

ax_399.plot(depths, [d**2*ion_rate[3] for d in depths])
ax_399.plot(depths, [d*inelastic_rates[3] for d in depths], linestyle="dashed")
#ax_399.plot([3.22, 3.22], [10, 1000000], color="black", linestyle="dotted", linewidth=1.5)

ax_515.set_yscale("log")
ax_515.set_ylim(10, 1000000)
ax_443.set_yscale("log")
ax_443.set_ylim(10, 1000000)
ax_414.set_yscale("log")
ax_414.set_ylim(10, 1000000)
ax_399.set_yscale("log")
ax_399.set_ylim(10, 1000000)

ax_515.legend(prop=font)
